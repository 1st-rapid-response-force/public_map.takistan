...
fnCoala_drawBackgroundImage =
{
	...
	MISSION_ROOT + "framework\3rd_party\CoalaOS\Images\background.jpg", 
	GUI_LEFT, 
	GUI_TOP,
	GUI_WIDTH,
...
fnCoala_changeExplorerPath = 
{
	...
	_folders = [[".."]] + _folders;
	{
		...
		_folderCtrl = ["RscPicture", MISSION_ROOT + "framework\3rd_party\CoalaOS\Images\" + _imageName + ".paa", 0,0,0,0] call addCtrl;
...
fnCoala_DrawDesktop = 
{
	_explorer = [GUI_LEFT + 2, GUI_TOP + 2, "framework\3rd_party\CoalaOS\Images\Hard-Drive-icon.paa", "C:\", 1.1] call fnCoala_AddDesktopIcon;
	...
	_cmd = [GUI_LEFT + 8, GUI_TOP + 2, "framework\3rd_party\CoalaOS\Images\cmd.paa", "cmd", 0.9] call fnCoala_AddDesktopIcon;
	...
	_browser = [GUI_LEFT + 14, GUI_TOP + 2, "framework\3rd_party\CoalaOS\Images\browser.paa", "Browser", 0] call fnCoala_AddDesktopIcon;
...
fnCoala_DrawWindow = 
{
	...
	MISSION_ROOT + "framework\3rd_party\CoalaOS\Images\windowBackground.jpg", 
	(_this select 0), 
	(_this select 1),
	_width,
	...
	_close = ["RscPicture", 
	MISSION_ROOT + "framework\3rd_party\CoalaOS\Images\close.paa", 
